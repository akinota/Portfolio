  ...
  <section class="section gray">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="heading">
            <h3><span>Add your place</span></h3>
          </div>
          <div class="sub-heading">
            <p>
              Please insert places you've been to as recommendations.
            </p>
          </div>
          <form action="post.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
              <input type="text" name="pname" class="form-control" placeholder="Place">
              <br>
              <input type="text" name="category" placeholder="Category" class="form-control">
              <br>
              <textarea type="text" name="ment" rows="5" placeholder="How did you get there and how was it? Please give me the detail" class="form-control"></textarea>
              <br>
              <center>Choose photo</center>
              <center><input type='file' name="images"></center>
              <br>
              <input type="hidden" name="userid" value="<?php echo $userID; ?>">
              <center><input type='submit' value='Upload' name='post' class="btn btn-theme"></center>
            </div>
          </form>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          ...
          $result = $post->display_specific_post($id);
            ...
            foreach($result as $row){
              ...
              echo "<center>";
              echo "<h5>" . $categ . "</h5> time<br><br><br><br>";
              echo "<a href='edit_post.php?post_id=$postID' type='submit' role='button' name='edit_post' value='' class='btn btn-theme'>Edit</a><br><br><br>";
              // echo "<a href='edit_post.php?post_id=$postID' type='submit' role='button' name='delete_post' value='' class='btn-sm'>Delete</a>";
              echo "</center>";
              echo "</div>";
              echo "</div>";
              echo "<hr>";
