    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          ...
          <br>
          <a href="user_post.php"><h6>Post</h6></a>
          <a href="timeline.php"><h6>Timeline</h6></a>
          <a href=""><h6>Favorite</h6></a>
          ...
          <form action="user.php" method="post">
            <div class="form-group">
              <label for="">Username</label>
                ...
                <center><button type="submit" name="edit_user" class="btn btn-theme">Save edit</button></center>
              </div>
            </form>
          </div>
        </div>
