        ...
        <div class="col-md-6">
          ...
          <form action="post.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input type="text" name="pname" value="<?php echo  $row['place']; ?>" class="form-control">
              <br>
              <input type="text" name="category" value="<?php echo $row['category']; ?>" class="form-control">
              <br>
              <textarea type="text" name="ment" rows="5" value="" class="form-control"><?php echo $row['mention']; ?></textarea>
              <br>
              <center>Choose photo</center>
              <center><input type='file' name="images" value=""><?php echo "<img src='upload/$images' width='320' height='250'>"?></center>
              <br>
              <center><input type='submit' value='Edit' name='edit_post' class="btn btn-theme"></center>
            </div>
          </form>
        </div>
      </div>
